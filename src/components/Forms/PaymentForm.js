...
function PaymentForm({ userData }) {
    ...
    const membershipDetails = {
        ...
        endDate: userData.membershipType === 'Monthly' 
    ...
    const expectedPaymentDate = new Date(new Date().setDate(new Date().getDate() + 3))
        .toLocaleDateString();
        ...
        if (paymentMethod === 'cash') {
            ...
            return (
                <div className={classes.paymentDetails}>
                    ...
                    <div className={classes.actions}>
                        <button type="button" onClick={handleCreditPayment}>Pay</button>
                    </div>
                </div>
            );
        }
